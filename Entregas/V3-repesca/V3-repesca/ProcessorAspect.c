...
case 'o': ComputerSystem_DebugMessage(130, 'h', OperatingSystem_GetExecutingProcessID(), registerPC_CPU, registerAccumulator_CPU, registerPSW_CPU, Processor_ShowPSW()); 
...
registerPC_CPU = Processor_CopyFromSystemStack(540 - 1); 
#line 220 "Processor.c"
registerPSW_CPU = Processor_CopyFromSystemStack(540 - 2); 
#line 221 "Processor.c"
registerAccumulator_CPU = Processor_CopyFromSystemStack(540 - 3); } }else{
Processor_RaiseInterrupt(EXCEPTION_BIT); }
...
Processor_CopyInSystemStack(540 - 1, registerPC_CPU); 
#line 253 "Processor.c"
Processor_CopyInSystemStack(540 - 2, registerPSW_CPU); 
#line 254 "Processor.c"
Processor_CopyInSystemStack(540 - 3, registerAccumulator_CPU); 
