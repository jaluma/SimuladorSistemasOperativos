...
extern int sleepingProcessesQueue[8]; 
...
for(i = 0;i < 8;i++) { processTable[i].busy = 0; } 
...
if (Heap_add(PID, readyToRunQueue[queueID], 1, (&numberOfReadyToRunProcesses[queueID]), 8) >= 0){
{ 
...
if (Heap_add(PID, sleepingProcessesQueue, 0, (&numberOfSleepingProcesses), 8) >= 0){
{ 
...
Processor_CopyInSystemStack(540 - 1, processTable[PID].copyOfPCRegister); 
#line 363 "OperatingSystem.c"
Processor_CopyInSystemStack(540 - 2, processTable[PID].copyOfPSWRegister); 
#line 364 "OperatingSystem.c"
Processor_CopyInSystemStack(540 - 3, processTable[PID].copyOfAccumulatorRegister); 
...
processTable[PID].copyOfPCRegister = Processor_CopyFromSystemStack(540 - 1); 
#line 403 "OperatingSystem.c"
processTable[PID].copyOfPSWRegister = Processor_CopyFromSystemStack(540 - 2); 
#line 406 "OperatingSystem.c"
processTable[PID].copyOfAccumulatorRegister = Processor_CopyFromSystemStack(540 - 3); 
