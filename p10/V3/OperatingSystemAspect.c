...
#line 140 "OperatingSystem.c"
int PID,i,j,numberOfSuccessfullyCreatedProcesses = 0;
...
if ((programList[j]->type) == ((unsigned int )1)){
PID = OperatingSystem_CreateProcess(j, 1); }else{
PID = OperatingSystem_CreateProcess(j, 0); }
